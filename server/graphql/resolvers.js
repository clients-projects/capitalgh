        ...
        try {
            ...
            if (hashedPassword) {
                const newUser = new User({
                    ...
                    referralLink: `https://fxcrytokeninvestment.com/Auth/signup?ref=${userData.username}`,
    ...
    getActivities: async function (arg, req) {
        ...
        try {
            ...
            if (updatedActivities) {
                ...
                updatedActivities.siteTotalPaidOut = Math.floor(
                    updatedActivities.totalPaidOut +
                        updatedActivities.siteTotalPaidOut
                )
                updatedActivities.siteTotalInvestments = Math.floor(
                    updatedActivities.totalInvestments +
                        updatedActivities.siteTotalInvestments
                )
                ...
                const activities = new Activities({
                    ...
                    newestMember: newestMember
                        ? newestMember.username
                        : 'Henry',
                    lastDepositName: lastDeposit
                        ? lastDeposit.creator.username
                        : 'Richard',
                    lastDepositAmount: lastDeposit ? lastDeposit.amount : 943,
                    lastWithdrawalName: lastWithdrawal
                        ? lastWithdrawal.creator.username
                        : 'Stephenie',
                    lastWithdrawalAmount: lastWithdrawal
